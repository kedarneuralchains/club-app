...
export function WhatsAppCopyButton({ meeting, members }: Props) {
  ...
  return (
    <div className="relative shrink-0">
      <button
        onClick={handleCopy}
        aria-label="Copy agenda to share on WhatsApp"
      ...
      {copied && (
        <span
          role="status"
          className="absolute top-full right-0 mt-1 z-10 whitespace-nowrap
                     bg-navy-700 text-white text-xs font-medium px-2.5 py-1 rounded-lg shadow-md"
        >
